...
(function() {
    ...
    // Game Configuration
    const CONFIG = {
        target: 100,          // Target clicks
        timeLimit: 10,        // Time in seconds
        decreasePerClick: 5,  // Gauge decrease per click
    ...
    function drawGauge() {
        ...
        if (m > 0) {
            ...
            fillGradient.addColorStop(0, "#ef5350");
            fillGradient.addColorStop(0.5, "#e53935");
            fillGradient.addColorStop(1, "#c62828");
